...
import {styled, useTheme, StyleSheet, Text, TextProps, ThemeKeyType} from "@/styled";
...
export type TextPropsType = TextProps & BaseTextPropsType;
...
export default function T(props: TextPropsType) {
  ...
  const stylesheet = useMemo(() => StyleSheet.flatten([{
